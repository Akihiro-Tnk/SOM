Packaging and Deploying SOMPkg
...
2. Installing the SOMPkg Package

A. Go to the directory that contains the file setup.py and the subdirectory SOMPkg. If 
...
3. Using the SOMPkg Package

The SOMPkg package is on your Python path. To import it into a Python script or session, 
   execute:
