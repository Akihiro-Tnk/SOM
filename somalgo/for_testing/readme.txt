Packaging and Deploying somalgo
...
2. Installing the somalgo Package

A. Go to the directory that contains the file setup.py and the subdirectory somalgo. If 
...
3. Using the somalgo Package

The somalgo package is on your Python path. To import it into a Python script or session, 
   execute:
